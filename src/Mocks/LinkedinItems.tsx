...
const linkedinItems = [
        ...
        content: [
            ...
            },
            {
                text: `
                    ...
                    • E, sob nenhuma circunstância, deve haver mais alguém na foto além de você.\n
                `,
            },
            {
    ...
    },
    {
        ...
        content: [
            ...
            {
                text: `
                    • Faça uma pergunta baseada ou uma declaração ousada que estimule o leitor a continuar;\n
                    • Mostre para o leitor (alvo) que possui a solução para resolver seu problema;\n
                    • Mostre a profundidade de sua experiência;\n
                    • Forneça exemplos tangíveis da área de seu desenvolvimento e especialização;\n
                    • Divulgue suas realizações e elogios;\n
                    • Diga-lhe o que o motiva a fazer seu trabalho;\n
    ...
    },
    {
        ...
        content: [
            {
                text: `Esta parte é o seu “currículo” do LinkedIn. Se a empresa não for muito conhecida, inclua um breve resumo do que a empresa faz, liste seu cargo e pontos destacando suas responsabilidades. Este é um ótimo lugar para adicionar palavras-chave.`,
            },
            {
                text: `
                    Como o LinkedIn não possui um “teclado” robusto, use este truque: digite um hífen seguido pelo sinal de maior que no teclado para formar uma seta para usar como marcador. Mostre progressão na carreira, mas mantenha-a em 3 ou 4 pontos principais.
                `,
            },
            {
                text: `
    ...
    },
    {
        ...
        content: [
            {
                text: `Os recrutadores começam com uma pesquisa por palavra-chave para encontrar candidatos viáveis. Faça uma busca rápida de emprego para as posições que você deseja. `,
            },
            {
                text: `
                    Identifique palavras-chave lendo os requisitos do trabalho. Inclua hard skills e soft skills – apenas se você tiver essas habilidades em seu repertório. 
                `,
            },
            {
                text : `
                    Essa também é uma ótima maneira de ver se você precisa aprimorar suas habilidades para se tornar mais comercializável.
                `
            },
            {
                text : `
                    Seja honesto e autêntico. Se você tem as habilidades, não seja tímido – mostre-se, mas faça-o autenticamente, não de uma maneira de cabeça quente. Sempre inclua o básico, incluindo a melhor maneira de chegar até você. 
                `
            },
            {
                text: `
