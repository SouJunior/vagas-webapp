...
const curriculoItems = [
  {
    ...
    intro:
      'Saiba como redigir um objetivo claro e direcionado à vaga desejada.',
  ...
  },
  {
    ...
    intro:
      'Preparar um currículo é mais do que apenas listar sua formação acadêmica. É uma oportunidade de se destacar.',
  ...
  },
  {
    ...
    intro:
      'Trabalho voluntário é um diferencial entre os demais candidatos, pois demonstra sua disposição em dar de si em prol de outros. ',
  ...
  },
  {
    ...
    intro:
      'Enfatize suas habilidades e competências para maximizar suas chances na vaga pretendida.',
  ...
  },
  {
    ...
    intro:
      'Destaque seus certificados e informações adicionais para turbinar seu currículo. Veja como:',
  ...
  },
  {
    ...
    title: 'O que Evitar',
    intro:
      'Por fim, é necessário tomar alguns cuidados para não deixar o seu currículo muito extenso ou difícil de ler. Confira o que deve ser evitado:',
