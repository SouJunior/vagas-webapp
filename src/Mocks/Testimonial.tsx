import type { TestimonialType } from '../@types/testimonial-type';
...
export const Testimonial: TestimonialType[] = [
  {
    ...
    Profile: '/assets/testimonial-joão-kremer.svg',
  },
  {
    ...
    Profile: '/assets/testimonial-wanderson-santos.svg',
  },
  {
    ...
    Profile: '/assets/testimonial-talita-bitencourt.svg',
  },
  {
    ...
    Profile: '/assets/testimonial-renato-saturnino.svg',
  },
];
