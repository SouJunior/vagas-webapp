...
export const CandidateSection = () => {
  ...
  return (
    <section className="bg-[rgba(51,138,255,0.05)] opacity-100">
      <div className="container mx-auto flex max-h-[600px] w-full min-w-[360px] flex-col items-start justify-center gap-6 p-6 max-[769px]:h-[641px] max-[769px]:items-center max-[451px]:h-[464px] max-[391px]:h-[464px] lg:h-[641px] lg:flex-row lg:gap-12 lg:p-8">
