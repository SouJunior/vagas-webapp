...
export const CandidateSection = () => {
  ...
  const ImageDescription =
    'Imagem de uma jovem, mexendo em um tablet em busca como se estivesse pesquisando por algo';
  ...
  return (
    <div className="flex max-h-[600px] w-full min-w-[360px] flex-col items-start gap-6 bg-[rgba(51,138,255,0.05)] p-6 opacity-100 max-[769px]:h-[641px] max-[769px]:items-center max-[451px]:h-[464px] max-[391px]:h-[464px] lg:h-[641px] lg:flex-row lg:gap-12 lg:p-8">
      ...
      <div className="relative flex w-full max-w-[582px] flex-col items-end justify-center text-center font-canada text-[rgba(0,57,134,1)] max-[769px]:mt-6 max-[769px]:items-center lg:items-start lg:text-left">
        ...
        <button
          onClick={handleClick}
          className="mt-6 flex h-[44px] w-[206px] items-center justify-center rounded-lg bg-[rgba(0,57,134,1)] text-white max-[451px]:h-[36px] max-[451px]:text-[14px] max-[391px]:mt-4 max-[391px]:h-[36px] max-[391px]:text-[14px]"
        >
          Quero me candidatar
        </button>
      </div>
