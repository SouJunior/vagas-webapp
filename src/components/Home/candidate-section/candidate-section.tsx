...
export const CandidateSection = () => {
    ...
    return (
        <section
            className="
            bg-[rgba(51,138,255,0.05)] opacity-100
        "
        >
            <div
                className="flex flex-col items-start justify-center  max-[769px]:items-center container mx-auto   
            w-full min-w-[360px] 
            max-h-[600px] p-6 gap-6  lg:h-[641px]
            ...
            "
                >
                    <p
                        className="font-semibold text-[20px] leading-[120%] mb-[120px]
                ...
                "
                    >
                        Um portal exclusivo para profissionais em início de
                        carreira!
                    </p>

                    <p
                        className="font-normal text-[16px] leading-[140%] 
                ...
                "
                    ...
                    <p
                        className="font-bold max-[391px]:text-[14px]
                max-[451px]:text-[14px]"
                    >
