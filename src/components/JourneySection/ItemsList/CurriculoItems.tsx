...
const curriculoItems = [
    {
        ...
        content: [
            ...
            {
                text: `Um texto assim soa vago, não diz nada. Supondo que você esteja tentando uma vaga de vendas em uma loja, você pode escrever algo como: Desejo atuar na área de vendas, aprimorando as minhas habilidades comerciais e ganhando experiência em lidar com o público.`,
            },
        ],
    },
    {
    ...
    },
    {
        ...
        content: [
            ...
            {
                text: `• Disponibilidade de viagem ou mudança: se você está tentando um emprego em outra cidade. Se você tem família no outro endereço, por exemplo, você pode destacar essa informação.\n
