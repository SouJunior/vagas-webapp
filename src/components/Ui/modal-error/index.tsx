...
export function ErrorModal({
  ...
  return (
    <div className="fixed inset-0 z-[1000] flex items-center justify-center bg-[#FBFDFF] bg-opacity-70">
      <div className="relative flex h-[508px] w-[804px] flex-col items-center justify-center gap-6 rounded-2xl border border-[#DEDEDE] bg-white p-6 font-canada shadow-xl">
        <button
          onClick={onClose}
        ...
        <div className="text-center">
          ...
          <p className="text-[16px] text-[#787878]">{message}</p>
        </div>
