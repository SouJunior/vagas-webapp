  ...
  return (
    <Footer>
      <div className="mobile-wrapper">
        ...
        <div>
          <p>
            A SouJunior ajuda você a encontrar um lugar de destaque para sua
        ...
        <div>
          ...
          >
            <img
              src="/assets/fork-me.png"
              alt="fork me on github logo"
              width="100px"
              height="29px"
            />
          </a>
        ...
        <div>
          <small>@ 2023 SouJunior Todos os direitos reservados.</small>
        </div>
