      ...
      <div className="flex my-14 ml-14 bg-gray-light">
        ...
        <div className="mr-14">
          ...
          <p className="text-gray-darker text-sm leading-4">
            ...
            <br /> destaque para sua primeira experiência profissional!
          </p>
          ...
          <div 
			className="flex text-blue text-3xl mt-2"
		  >
            <a href="" className="">
              <RiFacebookCircleFill />
            </a>
            ...
            <a 
				href="https://discord.gg/F2F2WqmB" 
				className="ml-3"
			>
              <RiDiscordFill />
            </a>
        ...
        <div className="flex flex-col pl-16 border-l-2 border-[#DEDEDE] font-canada">
          ...
          <a href="/" className="text-gray-darker mt-1.5 text-[17px] leading-5">
            Sobre nós
          </a>
          <a
            href="https://github.com/SouJunior"
